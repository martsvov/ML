...
train_spam_idx = spam_idx[0:-10]
train_ham_idx = ham_idx[0:-10]
test_spam_idx = spam_idx[-10:]
test_ham_idx = ham_idx[-10:]
train_data = list()
train_target = list()
test_data = list()
test_target = list()
...
def train(model, input_data, target_data, bs=5, iterations=5):
    ...
    for iter in range(iterations):
        ...
        for b_i in range(n_batches):
            ...
            print("\r\tLoss:" + str(iter_loss / (b_i + 1)))
        print()
    return model
